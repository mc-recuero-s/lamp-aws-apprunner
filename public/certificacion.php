<?php
  ...
  // 2 aprobado
  // 3 rechazado
  // 4 aprobado por contabilidad
  // 5 rechazado por contabilidad
  // 6 enviado
  // 7 rechazado por tesoreria
?>
...
<main class="certificacion">
  <header>
    <?php
      if($user['tipo'] =="101"){
    ?>
      <h2>Solicitud Certificado de Donacion en Efectivo</h2>
    <?php
      }
    ?>
    <?php
      ...
      <section class="efectivo">
        <div>
          <div class="efectivo_valor">
            ...
            <input name="valor_donacion" placeholder="Valor de la donación" class="entero"/>
          </div>
          <div class="destinatario">
            <label>Número de cuenta Destino</label>
            <select id="numero_destino" name="numero_destino">
              <option value="0" selected disabled>Seleccione...</option>
              <option value="Cuenta de Ahorros Bancolombia 100-724748-11">Cuenta de Ahorros Bancolombia 100-724748-11</option>
              <option value="Cuenta de Ahorros Bancolombia 648-027933-49">Cuenta de Ahorros Bancolombia 648-027933-49</option>
              <option value="Cuenta de Ahorros Bancolombia 005-188503-26">Cuenta de Ahorros Bancolombia 005-188503-26</option>
              <option value="Cuenta de Ahorros Bancolombia 005-000278-86">Cuenta de Ahorros Bancolombia 005-000278-86</option>
              <option value="Cuenta de Ahorros Bancolombia 005-000009-13">Cuenta de Ahorros Bancolombia 005-000009-13</option>
              <option value="Cuenta de Ahorros Bancolombia 005-000006-25">Cuenta de Ahorros Bancolombia 005-000006-25</option>
              <option value="Cuenta de Ahorros Bancolombia 005-000006-20">Cuenta de Ahorros Bancolombia 005-000006-20</option>
              <option value="Cuenta Corriente Bancolombia 648-026966-56">Cuenta Corriente Bancolombia 648-026966-56</option>
          </select>
          </div>
        </div>
        <div>
