<div class="content actual-list1">
  <div class="titulo">
    <section>
      <h4>Benefactores</h4>
      <div class="descargar descargarBenefactores" title="Crear Lista de Instituciones">
    ...
    <section>
      <div class="benefactores-check-in titulo-fecha">
        <input type="text" class="fecha-benefactores" />
      </div>
      <div class="benefactores-list">
  ...
  <section class="container benefactores">
